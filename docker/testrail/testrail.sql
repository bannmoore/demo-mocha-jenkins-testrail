...
INSERT INTO `preferences` VALUES (1,1,'goals','{\"2\":true}');
...
INSERT INTO `projects` VALUES (1,'My Project',NULL,0,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,1,1,NULL,NULL);
...
INSERT INTO `sections` VALUES (1,1,'Test Cases',1,0,NULL,NULL,0,NULL);
...
INSERT INTO `sessions` VALUES ('8cf868ed-f476-43c6-8b00-720617452d46','','',1474989184,'{\"user_id\":1,\"csrf\":\"H3SOxUzIApKpu0O2LurE\"}',1),('eb367f2c-28f9-4294-85c8-304362c09894','','',1521116690,'{\"user_id\":1,\"csrf\":\"3TQ1Wf1ICb.7w9SQKWM4\"}',2),('9b053b23-8a7a-4479-a4a2-c2b6bb815ffd','','',1524588378,'{\"user_id\":1,\"csrf\":\"qqKh2asRW0jJgMIC4Bx.\"}',3),('1f1bad76-d1e9-4d0c-ae1b-ea74fe6a2cb4','','',1525102139,'{\"user_id\":1,\"csrf\":\"kWWxEUWyrVMICcq8Tw4X\"}',4);
...
INSERT INTO `settings` VALUES (1,'database_version','183'),(2,'installation_name','TestRail QA'),(3,'installation_url','http://localhost:7070/testrail/'),(4,'attachment_dir',NULL),(5,'report_dir',NULL),(6,'default_language','en'),(7,'default_locale','en-us'),(8,'default_timezone',NULL),(9,'email_server',NULL),(10,'email_ssl','0'),(11,'email_from',NULL),(12,'email_user','testrail'),(13,'email_pass','newpassword'),(14,'email_notifications','1'),(15,'license_key','Jufi0qtf2baDnCL+zke29+4Qjy3pJHY/o0E55zKKcNJ1q7oGFh8lEW+bpBqc\r\nXykeNs9iv/ToM3rSSbuDiAvVj57aI5ZaDSFFcVGPR4RqLbMZHP1lYrv/B12H\r\nWsU1/ABL8IILlPTF4MCwfbk+8BeQLIkmsjM/V1uZe1x3KZ5azhmJhZ4Olwd+\r\noRjswGJtCw7qqRfBPNNnxzKck+DLhH97WkJg1ImGiTazofla3rerGplPHoiO\r\nE5W1XU3Wrv6E1nl2'),(29,'login_text',NULL),(30,'password_policy',NULL),(31,'password_policy_custom','.{15,}\r\n[a-z]\r\n[A-Z]\r\n[0-9]\r\n[`~!@#$%^&*()\\-_=+[\\]|;:\'\",<>./?]'),(32,'password_policy_desc','Minimum of 15 characters, at least one lower & upper case character, a number and a special character.'),(33,'forgot_password','1'),(34,'invite_users','1'),(35,'ip_check','0'),(36,'ip_policy','; You can use simple IP addresses:\r\n; 192.168.1.1\r\n; Or entire networks:\r\n; 192.168.1.0/24'),(37,'check_for_updates','1'),(38,'edit_mode','86400'),(39,'name_format','0'),(40,'partial_count','500'),(41,'apiv2_enabled','1'),(42,'apiv2_session_enabled','1');
...
INSERT INTO `suites` VALUES (1,'Master',1,NULL,1521116053,1,0,NULL,1,0,NULL,0,NULL);
...
INSERT INTO `user_logins` VALUES (1,'testrail',1474989177,1474989177,1),(2,'admin@admin.com',1474989181,1525102103,0);
...
INSERT INTO `user_tokens` VALUES (1,1,2,NULL,'39TcJLXTVR9DJj1pZbFg','1:$2y$10$o3F/xdJJScVBL0RLiEiRXONiV0oRt.IZsFdDacoQrDGLRAE4Vc8Ku',1474989184,1477581184),(2,1,2,NULL,'iB9QyNGNYJ1BZNuGB9bM','1:$2y$10$WXZRBEB5RsdgdAi2Nnsg5.LQY7ryG..cUaFZ.6amd.Y8K4S9G8QGe',1521115965,1523707965),(3,1,2,NULL,'uDEYaF2.4WWZhcHo4twd','1:$2y$10$u5C3ynNOPOxKG1tTcSedPOEZIGF8GYFILmh2l5vITW/TE7daFUWpi',1524588367,1527180367),(4,1,2,NULL,'Vt.MUTdXIPL3rCyA9/Vk','1:$2y$10$9xqdIhHiWz06si3/9tzyLuRorfjX8fozjrbootXbJEyjsujZvnIBS',1525102103,1527694103);
...
INSERT INTO `users` VALUES (1,'admin','admin@admin.com',1,'','1:$2y$10$a2HpQCsM.wGQpZsH2hPrXeAadH9WCR78fooqf.sPpZPhBGXnMamFO',1,'',NULL,NULL,0,'',1,NULL,NULL,NULL);
...
-- Dump completed on 2018-04-30 15:30:57
